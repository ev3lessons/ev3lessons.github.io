...
return f[d]=document.createElement("canvas"),f[e]=f[d].getContext("2d"),f["$"+d]=a(f[d]),f["$"+d].attr("class","wPaint-canvas"+(b?"-"+b:"")).attr("id","wPaint-canvas"+(b?"-"+b:"")).attr("width",f.width+"px").attr("height",f.height+"px").css({
...
,setTheme:function(a){
var b,c;
for(a=a.split(" "),this.$el.attr("class",(this.$el.attr("class")||"").replace(/wPaint-theme-.+\s|wPaint-theme-.+$/,"")),b=0,c=a.length;
c>b;
b++)this.$el.addClass("wPaint-theme-"+a[b])}
,setMode:function(a){
...
left:this.$el.outerWidth()/2-f.outerWidth(!0)/2,top:this.$el.outerHeight()/2-f.outerHeight(!0)/2}
),f.fadeIn(500)}
,_createMenu:function(a,b){
return b=b||{
}
,b.alignment=this.options.menuOrientation,b.handle=this.options.menuHandle,new c(this,a,b)}
,_fixMenus:function(){
function b(b,d){
var e=a(d),f=e.clone();
...
,c=this._getPixel(this.ctx,b),d=null;
...
,h=this.$menuHolder.children(".wPaint-menu-icon-group-"+b.group),i=h.length,j=null,k=null,l=null,m=0;
...
for(d=0,e=b.range.length;
e>d;
d++)f=this._createSelectOption(i,b.range[d]),f.on("click",c),b.useRange&&f.css(b.name,b.range[d]);
return h
}
...
mode:"click",generateButton:!1,dropperButton:!0,onSelect:c,onDropper:d
}
),f
}
...
this.$menu.css({
left:a.left+this.dockOffset.left,top:a.top+this.dockOffset.top
}
)
}
,_setIndex:function(){
...
,a.fn.wPaint.defaults,c),c.lineWidth=parseInt(c.lineWidth,10),c.fontSize=parseInt(c.fontSize,10),this.each(e)
}
...
path:"/",theme:"standard classic",autoScaleImage:!0,autoCenterImage:!0,menuHandle:!0,menuOrientation:"horizontal",menuOffsetLeft:5,menuOffsetTop:5,bg:null,image:null,imageStretch:!1,onShapeDown:null,onShapeMove:null,onShapeUp:null
}
...
switch(event.type){
case"touchstart":c="mousedown";
break;
case"touchmove":c="mousemove",event.preventDefault();
break;
