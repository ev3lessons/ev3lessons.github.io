...
document.write('\
<div ng-app="myAppa" ng-controller="myCtrla">\
\
\
    ...
    <ul>\
	 ...
	 <li>\
            ...
            <ul>\
                ...
                <li><a href="resources/drawplan#'+language+'">{{Mtwotwo}}</a></li>\
                <li><a href="resources/wheelconverter#'+language+'">{{Mtwothree}}</a></li>\
        ...
        <li>\
            <a href="mission.html#'+language+'">{{Mthreezero}}<span class="arrow">&#9660;</span></a>\
            <ul>\
                <li><a href="mission.html#'+language+'">{{Mthreeone}}</a></li>\
                <li><a href="contributors.html#'+language+'">{{Mthreetwo}}</a></li>\
                <li><a href="contributorfaq.html#'+language+'">{{Mthreethree}}</a></li>\
		<li><a href="press.html#'+language+'">{{Mthreefour}}</a></li>\
